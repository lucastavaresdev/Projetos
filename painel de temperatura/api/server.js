...
const execQuery = require ('./routes/db');

// ROTAS

app.get('/hcor/beacons_temperatura_atual', (req, res) =>{
...
app.get('/hcor/beacons_temperatura_atual/:mac', (req, res) =>{
...
app.get('/umdi/temperatura_atual/:mac', (req, res) =>{
...
app.get('/hcor/temperatura_media', (req, res) =>{
...
app.get('/umdi/temperatura_media_hora/:mac', (req, res) =>{
